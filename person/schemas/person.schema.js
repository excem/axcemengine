...
let Person = (() => {
    ...
    (() => {
        ...
        _name_decorators = [Prop({ required: true })];
        _gender_decorators = [Prop({ required: false })];
        _type_decorators = [Prop({ required: true })];
        _age_decorators = [Prop({ required: true })];
        _emoji_decorators = [Prop({ required: true })];
        _image_decorators = [Prop({ required: true })];
        _id_number_decorators = [Prop({ required: true, index: true })];
        _passport_number_decorators = [Prop({ required: true })];
        _interests_decorators = [Prop({ type: [String], default: [] })];
        _mother_id_decorators = [Prop({ index: true })];
        _father_id_decorators = [Prop({ index: true })];
        _children_decorators = [Prop({ index: false })];
        _address_decorators = [Prop({ type: AddressSchema, required: true })];
        _documents_decorators = [Prop({ type: [DocumentItemSchema], default: [] })];
        _businesses_decorators = [Prop({ type: [BusinessSchema], required: false })];
